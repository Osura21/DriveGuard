...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      content: "driveguard@gmail.com",
      detail: "Project research inquiries",
    },
    {
      icon: Clock,
      title: "Office Hours",
    ...
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in-up">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primary mb-3">Contact</p>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Contact <span className="text-primary">Us</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get in touch with the DriveGuard research team at SLIIT.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-6 animate-slide-in-left">
            <div>
              <h3 className="text-2xl font-bold mb-6">Project Communication</h3>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Use this section for project questions, collaboration requests, documentation reviews, and evaluation
                communication related to the DriveGuard system.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {contactInfo.map((info, index) => {
                ...
                return (
                  <Card
                    key={info.title}
                    className="border-2 transition-all duration-300 hover:border-primary hover:shadow-lg animate-fade-in"
              ...
              <CardContent className="pt-6">
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input placeholder="Project inquiry" className="border-2" />
                  </div>
